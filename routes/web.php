...
Route::prefix('admin')->middleware(['auth','isadmin'])->group(function(){
    ...
    Route::get('/add-post', [App\Http\Controllers\Admin\PostsController::class, 'create']);
    Route::post('/add-post', [App\Http\Controllers\Admin\PostsController::class, 'store']);
    Route::get('/post/{post_id}', [App\Http\Controllers\Admin\PostsController::class, 'edit']);
    Route::put('/update-post/{post_id}', [App\Http\Controllers\Admin\PostsController::class, 'update']);
    Route::get('/delete-post/{post_id}', [App\Http\Controllers\Admin\PostsController::class, 'destroy']);
